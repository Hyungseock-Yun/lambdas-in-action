...
public class FunctionNegateAnd {
	public static void main(String[] args) {
		...
		Predicate<Apple> greenOrHeavyApple = notRedApple.or(apple -> apple.getWeight() >= 200);

		System.out.println(filterApples2(inventory, notRedApple));
		System.out.println(filterApples2(inventory, redHeavyApple));

		System.out.println("FunctionNegateAnd.main");
		filterApples2(inventory, greenOrHeavyApple)
